...
There are also plenty of open issues we'd love help with. The issues you may find [`here`](https://github.com/OpenProduct/openmask-extension/issues).
...
- [ ] **Add to the CHANGELOG**: Help us keep track of all the moving pieces by adding an entry to the [`CHANGELOG.md`](https://github.com/OpenProduct/openmask-extension/blob/main/CHANGELOG.md) with a link to your PR.
